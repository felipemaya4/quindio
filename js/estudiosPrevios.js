...
formulario.addEventListener('submit', function(e) {
    ...
    if (document.getElementsByTagName('li').length == 0) {
        ...
        /////////////// se inserta e estudio previo a al base de datos
...
/// funcion para generar el documento del estudio previo
async function generardocumento(numeroPrecontractual) {
    ...
    const obligaciones = contenidoFormulario.listaObligaciones;
    const listaDeObligacionesAMostrar = [];
    // se formatea el valor de cada obligacion para mostrarlo en el documento de forma estilizada
    obligaciones.forEarch((text) => {
